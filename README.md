...
3) On Windows you can add a right-click command to run Jupyter Notebook and Jupyter Lab (recomended) in a particular directory (e.g. the PyCalcolAr directory) by merging <a href="https://bitbucket.org/andrebis/pycalcolar/src/master/helpers/Jupyter_right_click.reg" download="the keys that yo can download here">download this</a>
