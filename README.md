...
3) On Windows you can add a right-click command to run Jupyter Notebook and Jupyter Lab (recomended) in a particular directory (e.g. the PyCalcolAr directory) by merging [the keys that you can download from here](https://bitbucket.org/andrebis/pycalcolar/raw/9949295e1857d10dd54a3a4c3cd31797e3be013e/helpers/Jupyter_right_click.reg).
